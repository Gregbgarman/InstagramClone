...
import static com.example.instagramclone.MainActivity.CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE;
...
public class ComposeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //pic = view.findViewById(R.id.PicButton);
        submit = view.findViewById(R.id.SubmitButton);
        postimage = view.findViewById(R.id.theimage);
